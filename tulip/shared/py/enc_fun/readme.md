...
For ergonomics, this program requires you to position the encoder row rotated 180 deg on your table so "CH8" is upside down and on the left and "CH1" is upside down on on the right.  That makes the I2C cable flow better.
